...
echo "2. Review ~/.zshrc and remove any redundant configurations outside the Ansible managed block"
echo "3. Configure application-specific settings manually"
echo "4. Log into your applications (1Password, Slack, etc.)"
echo "5. Your custom Powerlevel10k configuration is installed (run 'p10k configure' to reconfigure if desired)"